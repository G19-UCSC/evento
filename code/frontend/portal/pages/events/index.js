...
export default function Package() {
  ...
  useEffect(() => {
    axios.get("/package").then((res)=>{
      console.log(res)
    setProducts(res.data.packages)
    setProductsAll(res.data.packages)
...
const handleClick = (item) => {
  ...
  return (
     ...
     <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.html">Events</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Packages</strong></div>
        </div>
      </div>
    </div>
          ...
          <div class="col-md-9 order-2">
            ...
            <div class="row">
              <div class="col-md-12 mb-5">
                <div class="float-md-left mb-4"><h2 class="text-black h5">Packages All</h2></div>
                <div class="d-flex">
              ...
              <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up" key={i}>
                <div class="block-4 text-center border">
                  <figure class="block-4-image">
                    <a href="shop-single.html"><img src="https://i.ibb.co/mtKKRWF/pngtree-black-gift-box-png-image-2580171-removebg-preview.png" style={{objectFit: "cover",height: "200px"}} layout='fill' alt="Image placeholder" class="img-fluid" /></a>
                  </figure>
                  ...
                  <div class="d-flex justify-content-between mb-2" style={{ marginTop: "20px"}}>
                    <Link href=" "><button type="button" class="w-100 btn btn-dark" onClick={() => router.push(`/events/${item._id}`)}>View Package</button></Link>
                  </div>
                </div>
              </div>
              ))
