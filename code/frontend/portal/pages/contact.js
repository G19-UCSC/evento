                            ...
                            <form className="needs-validation" noValidate="" onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <div class="p-3 p-lg-5 border">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <label for="v_fname" class="text-black">First Name <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="firstname" name="firstname"{...register('firstname', { required: true })} />
                                        </div>
                                        <div class="col-md-6">
                                            <label for="v_lname" class="text-black">Last Name <span class="text-danger">*</span></label>
